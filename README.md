...
<table style="width:30%;height: 50%">
  <tr>
  <th style="width: 25%"><img src="assets\SAMUEL STATIST.png" alt="samueleffiong  STATIST" style="height:80%;width: 40%"></th>
  </tr>
</table>
| Movie Actor ✨
<table style="width:30%;height: 50%">
  <tr>
  <th style="width: 25%"><img src="assets\movie samu.jpg" alt="samueleffiong movie picture" style="height:80%;width: 40%"></th>
  <th style="width: 25%"><img src="assets\sound samuel.jpg" alt="samueleffiong sound" style="height:80%;width: 40%"></th>
  </tr>
</table>
| Sound, Media Engineer ✨| ICT consultant.
<!---fist table image---->
<table style="width:30%;height: 50%">
  <tr>
...
<!--- SOCIAL MEDIA HANDLE --->
<!---https://samueleffiongjacob.github.io/30-Days-challenge-by-Techathon-/-->